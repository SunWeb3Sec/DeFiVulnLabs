...
function setUp() public { 
        ...
        SimpleBankBugContract = new SimpleBankBug(address(LendingPoolContract),address(USDaContract));
        USDaContract.transfer(address(LendingPoolContract), 10000 ether);
        FixedSimpleBankContract = new FixedSimpleBank(address(LendingPoolContract),address(USDaContract));

    }

function testFlashLoanFlaw() public {
        LendingPoolContract.flashLoan(500 ether,address(SimpleBankBugContract),"0x0");
    }

function testFlashLoanSecure() public {
        LendingPoolContract.flashLoan(500 ether,address(FixedSimpleBankContract),"0x0");
    }
